        ...
        <>
            <div className="flex flex-row flex-nowrap justify-center align-middle">
                <div className="flex flex-row flex-nowrap bg-nctdream mb-2 lg:mb-0 p-1 gap-x-1">
                    <img className="h-12 w-12 p-px border border-black" src="https://assets.nctdiscography.com/thumbnail_haechanpeek_180633a969.png" alt="Haechan peeking through curtains" />
